...
namespace DigitalRuby.SoundManagerNamespace
{
    ...
    public class LoopingAudioSource
    {
		...
		public bool Play(AudioClip clip, float targetVolume, bool isMusic)
		{
			if (AudioSource != null)
			{
				AudioSource.volume = startVolume = (AudioSource.isPlaying ? AudioSource.volume : 0.0f);
    ...
    public static class SoundManagerExtensions
    {
		...
		public static void PlayLoopingMusicManaged(this AudioSource source,AudioClip clip ,float volumeScale, float fadeSeconds, bool persist)
		{
			SoundManager.PlayLoopingMusic(source, clip , volumeScale, fadeSeconds, persist);
		}
		...
		public static void MusicVolumeMultiplier(this AudioSource source,float volume)
		{
			//SoundManager.MusicVolume = volume;
			List<LoopingAudioSource> musices = SoundManager.GetLoopingMusicSource();

			foreach (LoopingAudioSource s in musices)
			{
				if (!s.Stopping)
				{
		...
		public static void MusicAllPauseMultiplier(this AudioSource source)
		{
			SoundManager.PauseAllMusic();
		}

		public static void MusicAllresumeMultiplier(this AudioSource source)
		{
    ...
    public class SoundManager : MonoBehaviour
    {
        ...
        /// </summary>
        public static int MaxDuplicateAudioClips = 30;

		public static List<LoopingAudioSource> GetLoopingMusicSource()
		{
			return music;
		}
		...
		private static void PlayLooping(AudioSource source, AudioClip clip ,List<LoopingAudioSource> sources, float volumeScale, float fadeSeconds, bool persist, bool stopAll)
		{
			EnsureCreated();
		...
		public static void PlayLoopingMusic(AudioSource source,AudioClip clip ,float volumeScale, float fadeSeconds, bool persist)
		{
			PlayLooping(source, clip, music, volumeScale, fadeSeconds, persist, true);
			UpdateMusic();
		}
